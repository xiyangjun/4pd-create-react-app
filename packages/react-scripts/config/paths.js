...
if (
    !reactScriptsLinked &&
    __dirname.indexOf(path.join('packages', '4pd-react-scripts', 'config')) !== -1
) {
    ...
    module.exports = {
        ...
        proxySetup: resolveOwn(`${templatePath}/setupProxy.js`),
        appNodeModules: resolveOwn('node_modules'),
        dllConfig: resolveApp(`${templatePath}/lib`),
        publicUrlOrPath,
        // These properties only exist before ejecting:
        ownPath: resolveOwn('.'),
